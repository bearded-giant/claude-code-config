...
description: Find usage and design patterns in Python codebases (Flask, SQLAlchemy, JWT, analytics). Use when the user says "how is X used in this repo", "find all places we do Y", "show SQLAlchemy model structure here", "where do we validate tokens", or any cross-file pattern lookup. Skip for single-file edits or generic Python questions unrelated to this codebase's conventions.
model: sonnet
color: yellow
---
